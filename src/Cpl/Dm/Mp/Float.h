...
public:
    ...
    virtual int8_t read( float& dstData, uint16_t* seqNumPtr=0 ) const noexcept;

    /// Type safe write. See Cpl::Dm::ModelPoint
    virtual uint16_t write( float newValue, LockRequest_T lockRequest = eNO_REQUEST ) noexcept;
