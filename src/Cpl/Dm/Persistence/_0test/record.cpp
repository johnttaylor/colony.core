...
{
public:
    MyRecord( Cpl::Persistence::Chunk& chunkHandler ) noexcept
        : Record( m_itemList, chunkHandler )
    {
...
TEST_CASE( "record" )
{
    ...
    Cpl::Persistence::FileAdapter fd1( FILE_NAME_REGION1, 0, 128 );
    Cpl::Persistence::FileAdapter fd2( FILE_NAME_REGION2, 0, 128 );
    Cpl::Persistence::MirroredChunk chunk( fd1, fd2 );
    MyRecord uut( chunk );
    static Cpl::Persistence::Record* records[2] ={ &uut, 0 };
