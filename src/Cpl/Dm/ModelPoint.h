...
public:
    /** This method converts the Model Point's data to JSON string and
        ...
        \endcode
     */
    virtual bool toJSON( char* dst, size_t dstSize, bool& truncated ) noexcept = 0;
...
public:
    /** This method is used to export the Model Point's instance data content
        ...
        time of the export.
     */
    virtual size_t exportData( void* dstDataStream, size_t maxDstLength, uint16_t* retSequenceNumber=0 ) const noexcept = 0;
     ...
     */
    virtual size_t importData( const void* srcDataStream, size_t srcLength, uint16_t* retSequenceNumber=0 ) noexcept = 0;
...
public:
   ...
   */
    virtual size_t getInternalDataSize() const noexcept = 0;
