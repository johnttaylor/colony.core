...
public:
    /** Adds an item to the top of the stack.  Returns true if succesful;
    ...
    /** Removes the top item of the stack.  If the stack is empty, then
        ...
        is used to return stats/result of the pop operation operation,
        i.e. when *statusPtr == false then the pop operation failed and
    ...
    /** Returns the item on the top of the Stack. The returned item 
        ...
        stats/result of the pop operation operation, i.e. when 
        *statusPtr == false then the peek operation failed and the returned 
        value is invalid.
     */
