#ifndef Cpl_Rte_StaticInfo_h_
#define Cpl_Rte_StaticInfo_h_
/*-----------------------------------------------------------------------------
...
/** This class defines an interface for a Point to store its constant/static 
    data in program memory.  Concrete leaf classes can extended this class
    to provide additional constant parameters.  

    How to extend:
    1) A new child class is defined and must inherit from StaticInfo.  This 
