#ifndef Cpl_Rte_Point_Int8_h_
#define Cpl_Rte_Point_Int8_h_
/*-----------------------------------------------------------------------------
...
{
protected:
    // Base for to/from string operation. True=base 16, False=base 10
    bool m_hexFormat;

public:
    /// Constructor.  
    Int8( int8_t initialValue = 0, bool hexStringFormat=false );
