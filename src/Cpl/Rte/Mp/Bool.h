...
public:
    ...
    virtual uint16_t read( bool& dstData, int8_t& validState ) const throw();
    ...
    typedef Cpl::Rte::ModelPointRmwCallback<bool> Client;
...
public:
    ...
    typedef Cpl::Rte::Subscriber<Bool> Observer;
