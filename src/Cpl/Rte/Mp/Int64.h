#ifndef Cpl_Rte_Mp_Int64_h_
#define Cpl_Rte_Mp_Int64_h_
/*-----------------------------------------------------------------------------
...
public:
     ...
     */
    Int64( Cpl::Rte::ModelDatabase& myModelBase, StaticInfo& staticInfo, bool decimalFormat=true );

    /// Constructor. Valid MP.  Requires an initial value
    Int64( Cpl::Rte::ModelDatabase& myModelBase, StaticInfo& staticInfo, int64_t initialValue, bool decimalFormat=true );

public:
    /// Type safe read. See Cpl::Rte::ModelPoint
    virtual int8_t read( int64_t& dstData, uint16_t* seqNumPtr=0 ) const throw();

    /// Type safe write. See Cpl::Rte::ModelPoint
    virtual uint16_t write( int64_t newValue, LockRequest_T lockRequest = eNO_REQUEST ) throw();

    /// Type safe read-modify-write client callback interface
    typedef Cpl::Rte::ModelPointRmwCallback<int64_t> Client;
...
public:
    ...
    typedef Cpl::Rte::Subscriber<Int64> Observer;
