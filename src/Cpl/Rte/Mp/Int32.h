...
public:
     ...
     */
    Int32( Cpl::Rte::ModelDatabase& myModelBase, StaticInfo& staticInfo, bool decimalFormat=true );

    /// Constructor. Valid MP.  Requires an initial value
    Int32( Cpl::Rte::ModelDatabase& myModelBase, StaticInfo& staticInfo, int32_t initialValue, bool decimalFormat=true  );

public:
    /// Type safe read. See Cpl::Rte::ModelPoint
    virtual int8_t read( int32_t& dstData, uint16_t* seqNumPtr=0 ) const throw();

    /// Type safe write. See Cpl::Rte::ModelPoint
    virtual uint16_t write( int32_t newValue, LockRequest_T lockRequest = eNO_REQUEST ) throw();

    /// Type safe read-modify-write client callback interface
    typedef Cpl::Rte::ModelPointRmwCallback<int32_t> Client;
...
public:
    ...
    typedef Cpl::Rte::Subscriber<Int32> Observer;
