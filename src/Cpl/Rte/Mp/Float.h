#ifndef Cpl_Rte_Mp_Float_h_
#define Cpl_Rte_Mp_Float_h_
/*-----------------------------------------------------------------------------
...
public:
    ...
    virtual int8_t read( float& dstData, uint16_t* seqNumPtr=0 ) const throw();

    /// Type safe write. See Cpl::Rte::ModelPoint
    virtual uint16_t write( float newValue, LockRequest_T lockRequest = eNO_REQUEST ) throw();

    /// Type safe read-modify-write client callback interface
    typedef Cpl::Rte::ModelPointRmwCallback<float> Client;
...
public:
    ...
    typedef Cpl::Rte::Subscriber<Float> Observer;
