...
static Cpl::Rte::StaticInfo                 info_mp_apple_( "APPLE" );
static Persistence::Record::MpServerStatus  mp_apple_( modelDb_, info_mp_apple_ );

static Cpl::Rte::StaticInfo                 info_mp_orange_( "ORANGE" );
...
TEST_CASE( "serverstatus-get", "[serverstatus-get]" )
{
    ...
    REQUIRE( strcmp( mpType, "Cpl::Rte::Persistence::Record::ServerStatus" ) == 0 );
