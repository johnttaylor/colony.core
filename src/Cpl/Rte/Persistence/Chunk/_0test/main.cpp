...
#include "Cpl/Rte/Persistence/Chunk/Null.h"
...
////////////////////////////////////////////////////////////////////////////////
void dumpPayload( Cpl::Rte::Persistence::Chunk::Request::OpenFilePayload& payload, const char* msg1, const char* msg2="" )
{
...
void dumpPayload( Cpl::Rte::Persistence::Chunk::Request::CloseFilePayload& payload, const char* msg1, const char* msg2="" )
{
    CPL_SYSTEM_TRACE_MSG( SECT_, ("") );
...
void dumpPayload( Cpl::Rte::Persistence::Chunk::Request::ReadPayload& payload, const char* msg1, const char* msg2="" )
{
    CPL_SYSTEM_TRACE_MSG( SECT_, ("") );
...
void dumpPayload( Cpl::Rte::Persistence::Chunk::Request::WritePayload& payload, const char* msg1, const char* msg2="" )
{
    CPL_SYSTEM_TRACE_MSG( SECT_, ("") );
...
TEST_CASE( "chunk", "[chunk]" )
{
    ...
    // Clear the database
    {
        Cpl::Rte::Persistence::Chunk::Request::ClearFilePayload  payload( buffer_, MAX_BUF_SIZE_ );
        Cpl::Itc::SyncReturnHandler                              srh;
        Cpl::Rte::Persistence::Chunk::Request::ClearFileMsg      msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "CLEAR FILE" );
        REQUIRE( payload.m_result == +Cpl::Rte::Persistence::Chunk::ServerResult::eERR_FILEIO );
    }

    // Open the database
    {
        Cpl::Rte::Persistence::Chunk::Request::OpenFilePayload   payload( buffer_, MAX_BUF_SIZE_ );
        Cpl::Itc::SyncReturnHandler                              srh;
        Cpl::Rte::Persistence::Chunk::Request::OpenFileMsg       msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "OPEN FILE" );
        REQUIRE( payload.m_result == +Cpl::Rte::Persistence::Chunk::ServerResult::eEOF );
    }


    // Read 1st Record
    {
        Cpl::Rte::Persistence::Chunk::Request::ReadPayload   payload( buffer_, MAX_BUF_SIZE_, chunkHandle1_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::ReadFileMsg   msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
    ...
    // Read 2nd Record
    {
        Cpl::Rte::Persistence::Chunk::Request::ReadPayload   payload( buffer_, MAX_BUF_SIZE_, chunkHandle2_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::ReadFileMsg   msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
    ...
    // Write Record 1
    {
        ...
        Cpl::Rte::Persistence::Chunk::Request::WritePayload  payload( buffer_, sizeof( record1_ ), chunkHandle1_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::WriteFileMsg  msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
    ...
    // Write Record 2
    {
        ...
        Cpl::Rte::Persistence::Chunk::Request::WritePayload  payload( buffer_, sizeof( record2_ ), chunkHandle2_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::WriteFileMsg  msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
    ...
    // Close the file
    {
        Cpl::Rte::Persistence::Chunk::Request::CloseFilePayload  payload;
        Cpl::Itc::SyncReturnHandler                              srh;
        Cpl::Rte::Persistence::Chunk::Request::CloseFileMsg      msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
    ...
    // Read 1st Record
    {
        Cpl::Rte::Persistence::Chunk::Request::ReadPayload   payload( buffer_, MAX_BUF_SIZE_, chunkHandle1b_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::ReadFileMsg   msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "READ (1st)" );
    ...
    // Read 2nd Record
    {
        Cpl::Rte::Persistence::Chunk::Request::ReadPayload   payload( buffer_, MAX_BUF_SIZE_, chunkHandle2b_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::ReadFileMsg   msg( chunkServer_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "READ (2nd)" );
    ...
    // Open the database
    {
        Cpl::Rte::Persistence::Chunk::Request::OpenFilePayload   payload( buffer_, MAX_BUF_SIZE_ );
        Cpl::Itc::SyncReturnHandler              srh;
        Cpl::Rte::Persistence::Chunk::Request::OpenFileMsg       msg( chunkServer2_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "OPEN FILE" );
        REQUIRE( payload.m_result == +Cpl::Rte::Persistence::Chunk::ServerResult::eEOF );
    }
    ...
    // Read 1st Record
    {
        Cpl::Rte::Persistence::Chunk::Request::ReadPayload   payload( buffer_, MAX_BUF_SIZE_, chunkHandle1c_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::ReadFileMsg   msg( chunkServer2_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "READ (1st)" );
        REQUIRE( payload.m_result == +Cpl::Rte::Persistence::Chunk::ServerResult::eEOF );
        REQUIRE( payload.m_handlePtr->m_generation == 0 );
    ...
    // Read 2nd Record
    {
        Cpl::Rte::Persistence::Chunk::Request::ReadPayload   payload( buffer_, MAX_BUF_SIZE_, chunkHandle2c_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::ReadFileMsg   msg( chunkServer2_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "READ (2nd)" );
    ...
    {
        memcpy( buffer_, record1_, sizeof( record1_ ) );
        Cpl::Rte::Persistence::Chunk::Request::WritePayload  payload( buffer_, sizeof( record1_ ), chunkHandle1c_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::WriteFileMsg  msg( chunkServer2_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "WRITE", "REC1" );
        REQUIRE( payload.m_result == +Cpl::Rte::Persistence::Chunk::ServerResult::eSUCCESS );
        REQUIRE( payload.m_handlePtr->m_generation == 1 );
    ...
    {
        memcpy( buffer_, record2_, sizeof( record2_ ) );
        Cpl::Rte::Persistence::Chunk::Request::WritePayload  payload( buffer_, sizeof( record2_ ), chunkHandle2c_ );
        Cpl::Itc::SyncReturnHandler                          srh;
        Cpl::Rte::Persistence::Chunk::Request::WriteFileMsg  msg( chunkServer2_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "WRITE", "REC2" );
    ...
    // Close the database
    {
        Cpl::Rte::Persistence::Chunk::Request::CloseFilePayload  payload;
        Cpl::Itc::SyncReturnHandler                              srh;
        Cpl::Rte::Persistence::Chunk::Request::CloseFileMsg      msg( chunkServer2_, payload, srh );
        chunkMailbox_.postSync( msg );
        dumpPayload( payload, "CLOSE FILE" );
        REQUIRE( payload.m_result == +Cpl::Rte::Persistence::Chunk::ServerResult::eSUCCESS );
    }
