...
Threads::Threads( Cpl::Container::Map<Cpl::TShell::Dac::Command>& commandList ) noexcept
	:Command( commandList, CPLTSHELLDACMD_CMD_THREADS_ )
	, m_contextPtr( 0 )
	, m_count( 0 )
	, m_io( true )
{
...
Threads::Threads( Cpl::Container::Map<Cpl::TShell::Dac::Command>& commandList, const char* ignoreThisParameter_onlyUsedWhenCreatingAStaticInstance ) noexcept
	:Command( commandList, CPLTSHELLDACMD_CMD_THREADS_, ignoreThisParameter_onlyUsedWhenCreatingAStaticInstance )
	, m_contextPtr( 0 )
	, m_count( 0 )
	, m_io( true )
{
...
///////////////////////////
Cpl::TShell::Dac::Command::Result_T Threads::execute( Cpl::TShell::Dac::Context_& context, Cpl::Text::Tokenizer::TextBlock& tokens, Cpl::Io::Output& outfd ) noexcept
{
	// Error checking
