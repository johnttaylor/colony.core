...
without incorruing any platform specific dependencies.  However, It is the 
Application's responsiblity to build & link the appropriate platform specific
implementation of these classes. 

This namespace also supplies a few concrete helper classes that can be used for
implementations of several Cpl::Io abstact interfaces using the same platform 
specific implementing of the 'File Streams' that was/is used for the standard 
Input, Output, Error streams.  

Note: The "_ansi/' implemenation of the Stdio classes uses the C library's 
