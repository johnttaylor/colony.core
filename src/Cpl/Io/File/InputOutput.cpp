...
//////////////////////////
unsigned long InputOutput::currentPos()
    {
    return Common_::currentPos( m_stream.m_out.m_outFd );
    }
...
bool InputOutput::isEof()
    {
    return m_stream.m_out.m_outEos || m_stream.m_in.m_inEos;
    }

unsigned long InputOutput::length()
    {
    return Common_::length( m_stream.m_out.m_outFd );
    }
