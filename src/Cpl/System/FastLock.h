...
/** This class defines an interface for a "Fast Lock".  A Fast Lock provides
    mutual exclusion and/or a critical section protection similiar to a Mutex 
    ...
    with the  following constraints:
        ...
        o Non recursive semantics.  The calling thread CANNOT attemp to acquire
    ...
    target platform specific and the implemenation can vary from disable/enable
