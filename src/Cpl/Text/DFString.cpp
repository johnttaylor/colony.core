...
////////////////////////////
DFString::DFString(void):FString_((const char*)0,new char[OPTION_CPL_TEXT_DFSTRING_ALLOC_BLOCK_SIZE],OPTION_CPL_TEXT_DFSTRING_ALLOC_BLOCK_SIZE-1){}
DFString::DFString(const DFString& string):FString_(string.getString(),new char[string.maxLength()+1],string.maxLength()){}
DFString::DFString(const String& string):  FString_(string.getString(),new char[string.maxLength()+1],string.maxLength()){}
DFString::DFString(size_t memSize, const DFString& string):FString_(string.getString(),new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, const String& string):FString_(string.getString(),  new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, const char* string):FString_(string,new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, char c):FString_(c,new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, int num):FString_(num,new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, unsigned num):FString_(num,new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, long num):FString_(num,new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, long long num):FString_(num,new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, unsigned long num):FString_(num,new char[MEMSIZE],MEMSIZE-1){}
DFString::DFString(size_t memSize, unsigned long long num):FString_(num,new char[MEMSIZE],MEMSIZE-1){}
