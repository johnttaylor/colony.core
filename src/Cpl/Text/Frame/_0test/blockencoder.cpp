...
#include "Cpl/Text/Frame/BlockEncoder.h"
...
////////////////////////////////////////////////////////////////////////////////
TEST_CASE( "BlockEncoder1" )
{
	Cpl::System::Shutdown_TS::clearAndUseCounter();

	// Small Block buffer
	static uint8_t blockBuffer[2];
	Cpl::Io::File::Output outfd( OUTFILE_NAME_ );

	{
		BlockEncoder encoder( blockBuffer, sizeof(blockBuffer), &outfd, SOF_, EOF_, ESC_ );
	...
	{
		BlockEncoder encoder( blockBuffer, sizeof(blockBuffer), &outfd, SOF_, EOF_, ESC_, false );
...
TEST_CASE( "BlockEncoder2" )
{
	Cpl::System::Shutdown_TS::clearAndUseCounter();

	// Large Block buffer
	static uint8_t blockBuffer[200];
	Cpl::Io::File::Output outfd( OUTFILE_NAME_ );
