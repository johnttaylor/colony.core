...
significant software components and/or modules.  This concept of an RTE is
based/derived from the AUTOSAR architecture (www.autosar.org). 
...
- A 'Point' is a physical collection of data.  The Point mechanisms provide the
  ability to create fairly sophisticated data structures. A Point consist of one 
...
- A 'Controller Point' is what the Application uses to synchronously write to
