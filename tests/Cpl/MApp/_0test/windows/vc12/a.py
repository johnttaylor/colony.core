...
if __name__ == '__main__':
    ...
    if ( os.path.isdir( '_win32' ) ):
        result, testoutput = runratt_base.run_ratt( tsuite, '_win32', exe, host, exeargs, True )
        print( testoutput )
        print

    if ( os.path.isdir( '_cpp11' ) and result == 0 ):
        result, testoutput = runratt_base.run_ratt( tsuite, '_cpp11', exe, host, exeargs, True )
        print( testoutput )
        print
