...
base_release.cflags       = '-m32 -Wall -Werror' # -DLFS_FILEBD_YES_TRACE -DLFS_YES_TRACE'
...
base_cpp11.cflags       = '-m64 -Wall -Werror -DLFS_FILEBD_YES_TRACE'
...
base_win64.cflags       = '-m64 -Wall -Werror'
